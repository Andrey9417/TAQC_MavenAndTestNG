...
import pagesForRozetka.MoveToMonitorSearchPage;

public class RozetkaCompareMonitorTest {
    ...
    public void test() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='menu__main-cats']//a[contains (@href, 'monitors')]"))).click();
        ...
        for (WebElement webElem : listOfElements) {
            ...
            if (Integer.parseInt(price) < 4000) {
                ...
                buttonAddToComparisonList = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("button.compare-button")));
        ...
        buttonAddToComparisonList.click();
